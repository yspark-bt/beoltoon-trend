...
const SUPPLEMENT_QUERIES = [
  // [A] 웹툰·만화책 — 만화책·웹툰 정주행 목적
  '웹툰 추천', '만화 추천', '웹툰 정주행', '숨은 웹툰',
  '만화책 추천', '만화책 정주행', '숨은 만화책',

  // [A] OTT — 4개 플랫폼 × 영화/드라마/예능 × 추천/인기 (24개, 위에서 생성)
  ...OTT_QUERIES,

  // [A] 보드게임 — 보드게임 목적
  '보드게임 추천', '보드게임 카페', '보드게임 브이로그',

  // [B] 이색카페·룸카페 투어 ★ 매장 공간을 그대로 촬영 가능한 핵심 포맷
  '이색카페 투어', '룸카페 추천', '테마카페 브이로그', '만화카페 브이로그',
